...
(
    ...
    `ai_suggest`      TINYINT(1) DEFAULT 0 COMMENT '摘要是否AI生成 0否 1是',
...
/*!40000 ALTER TABLE `article`
    DISABLE KEYS */;
INSERT INTO `article` (`id`, `title`, `summary`,`ai_suggest`, `content`, `category_id`, `cover`, `status`,
                       `is_top`, `is_hot`, `view_num`, `like_num`, `comment_num`,`words_num`, `create_time`, `update_time`,
                       `publish_time`, `user_id`, `delete_flag`, `sort`)
VALUES (1, 'Vue3 + ElementPlus后台管理实战', '从零搭建个人博客后端管理页面，实现文章增删改查',0,
       ...
       (2, '个人博客开发日记', '记录从选型到上线完整开发流程',0,
        ...
        0, 10),
       (3, 'MySQL常用查询优化技巧', '日常开发SQL语句调优实用方法',0,
       ...
       (4, 'JavaScript进阶语法指南', '梳理ES6+常用语法与实战用法',0,
       ...
       (5, '日常随笔：生活感悟', '平淡生活中的思考与记录', 0,'记录工作学习之余日常心境，分享成长路上点滴心得', 3,
       ...
       (6, 'SpringBoot接口统一封装', '后端接口规范化统一返回格式',
        0,'全局异常处理、参数校验、响应体封装，规范项目后端接口输出', 1,
