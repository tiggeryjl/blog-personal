...
const handleSizeChange = (size) => {
  ...
  const newCurrentPage = newTotalPages === 0 ? 1 : Math.min(props.currentPage, newTotalPages)
...
.page-btn:hover:not(:disabled) {
  border-color: #0582b4;
  color: rgb(113, 160, 218);
}

.page-btn.active {
  background: rgb(27, 12, 248);
  color: #fff;
  border-color: rgb(165, 127, 222);
}
